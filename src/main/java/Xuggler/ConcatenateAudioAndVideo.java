...
public class ConcatenateAudioAndVideo
{
  ...
  public static void main(String[] args)
  {
    ...
    /*File source1 = new File("F:\\IITB\\Client2.0\\output1.vlc");
    File source2 = new File("F:\\IITB\\Client2.0\\output.vlc");
    ...
    concatenate("F:\\IITB\\Client2.0\\output1.mp4", "F:\\IITB\\Client2.0\\output.mp4", "F:\\IITB\\Client2.0\\join.mp4");
  }
    ...
    String destinationUrl)
  {
    ...
    writer.close();
    System.out.println("Created "+destinationUrl);
  }
