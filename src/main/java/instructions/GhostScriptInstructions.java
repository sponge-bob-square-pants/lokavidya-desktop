...
public class GhostScriptInstructions {
	...
	public GhostScriptInstructions() {
		init();
	}
	...
	public void init() {
		...
		String installationFilePath = new File("resources", "gs_install_" + osPathString + ".txt").getAbsolutePath();
