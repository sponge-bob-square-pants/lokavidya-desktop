...
class DocumentConverter:
    ...
    def __init__(self, port=DEFAULT_OPENOFFICE_PORT):
        ...
        try:
            ...
            raise DocumentConversionException("failed to connect to OpenOffice.org on port {0}".format(port))
    ...
    def convert(self, inputFile, outputFile):
        ...
        if inputExt in IMPORT_FILTER_MAP.keys():
    ...
    def _overridePageStyleProperties(self, document, family):
        if family in PAGE_STYLE_OVERRIDE_PROPERTIES.keys():
